...
function WorkScheduleView({ activeTab: initialActiveTab = 'calendar' }) {
    ...
    const [dateRange, setDateRange] = useState({
        ...
        endDate: new Date(monday.getTime() + (35 * 24 * 60 * 60 * 1000)).toISOString().split('T')[0] // 5 weeks from Monday
    });
                ...
                <Row className="mb-4">
                    ...
                    <Col xs="auto">
                        <Form.Group className="d-flex align-items-center">
                            <Form.Label className="me-2 mb-0">View from:</Form.Label>
                            <Form.Control
                                type="date"
                                value={dateRange.startDate}
                                onChange={(e) => {
                                    const newStartDate = new Date(e.target.value);
                                    const newEndDate = new Date(newStartDate.getTime() + (35 * 24 * 60 * 60 * 1000));
                                    setDateRange({
                            ...
                            <Form.Text className="text-muted me-2">
                                (Showing 5 weeks from selected date)
                            </Form.Text>
                        </Form.Group>
                    </Col>
                </Row>
